...
<body>
	...
	<div class="visible-xs navbar navbar-inverse navbar-fixed-top" style="padding:0px 10px;margin:0px;border-bottom:1px solid #222;font-family:Tahoma;">		
			...
			<a href="#" class="btn btn-link navbar-btn"><i class="glyphicon glyphicon-plus fa-lg active-mobile" style="color:#aaa"></i></a>
			<!--btn collapse-->
		...
		<div class="container">
				<div class="navbar-left">
					<ul class="nav navbar-nav">
						...
						<li class="active"><a href="#"><i class="glyphicon glyphicon-plus fa-lg"></i></a></li>
						<li>
	...
	<!--create post-->
	<div style="display:none;width:100%;width:100%;position:fixed;z-index:9999;" id="container-create-post">
	...
	<div class="row">
		...
		<div class="col-lg-6 col-md-6 col-sm-10 col-xs-12" style="padding:0px">
			...
			<div class="query-p" style="height:100%;background:#e0e1e2 url('<?php echo base_url();?>images/background-center.png');border-width:0 2px;border-color:#ccc;border-style:solid;">
				<?php if(empty($posts)){ ?>
				<p style="text-align:center;margin-bottom:1000px;background-color:;font-family:Lucida Sans Unicode;font-size:17px;color:#666"><a href="<?php base_url();?>/discover" style="color:#444;text-decoration:none">Haz En este momento no hay fotos en el sistema.</a></p>
				<?php }else{ ?>
